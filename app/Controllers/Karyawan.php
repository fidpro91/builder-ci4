...
class Karyawan extends CoreController
{
    use ResponseTrait;
    protected $model;
    ...
    public function index()
    {
        ...
        return $this->get_theme('karyawan/index',$data,get_class($this));
    }
            ...
            [
                ...
                "rightTool"         => function($param){
                    return create_btnAction([
                        "update"=>[
                            "id_key"        => $param["id_key"],
                            "url"           => "karyawan/find_one",
                            "loadForm"      => "karyawan/show_form"
                        ],
                        "delete"=>[
                            "id_key"  => $param["id_key"],
                            "url"     => "karyawan/delete_row"
                        ]
                    ]);
                }
            ]
